...
namespace NetWebAssemblyTSTypeGenerator
{
    ...
    public class NetWebAssemblyTSTypeGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            File.WriteAllText(Path.Combine(jsPortOverrideTypeDefinitionOutputDir, $"index.js"), "export const getTypedAssemblyExports = (originalGetAssemblyExports) => originalGetAssemblyExports;");
